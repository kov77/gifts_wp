 <div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div>
                <?php echo do_shortcode('[contact-form-7 id="166" title="Форма вопросов"]') ?>
                </div>
            </div>
        </div>
        <footer>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('insta_link', 2); ?>" class="footer__social-item">
            ...
            wp_footer();
            ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDiGM7UnBxNo_UR_cewTv3dDYsdSiIi3Ho"></script>
