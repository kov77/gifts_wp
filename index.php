<?php
    ...
    ?>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-7 offset-1">
                                        <h2 
                                        style="
                                            <?php $field=get_field('slider_color');
                                            if($field == 'white') {
                                                ?>
                                                    color: #fff;
                                                <?php
                                        ...
                                        <?php $field=get_field('slider_btn');
                                            if($field == 'on') {
                                                ?>
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field("about_teem"); ?></div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field("teem_img"); ?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('first_history-subheader'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('first_history-descr'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('first_history-img'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('second_history-img'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                              <?php the_field('second_history-subheader'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('second_history-descr'); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('third_history-subheader'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('third_history-descr'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('third_history-img'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contacts" id="contacts">
            <h1 class="title"><?php the_field('location_header');?></h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined">
                           <?php the_field('location_descr');?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('tel_num-1', 2) ?>">+<?php the_field('tel_num-1', 2) ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('tel_num-2', 2) ?>">+<?php the_field('tel_num-2', 2) ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="165" title="Форма отзывов"]')?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
